...
function initNavMenu() {
	var hamburgerToggle = $('.hamburger').unbind();
	var navbarNav = $('.navbar__nav');
	...
	hamburgerToggle.on('click', function (e) {
		...
		navbarNav.slideToggle(function () {
...
/* ---------------------------------------------
 mixItUp
 --------------------------------------------- */
var mixItUpWrapper = document.querySelector('.works--wrap');

var mixer = mixitup(mixItUpWrapper, {
	selectors: {
		target: '.works--item'
	},
	classNames: {
