!function(t) {
    ...
    !function() {
        ...
        r.id = d), e.instances[d] instanceof e.Mixer ? (l = e.instances[d], (!i || i && i.debug && i.debug.showWarnings !== !1) && console.warn(e.messages.warningFactoryPreexistingInstance())) : (l = new e.Mixer(), 
        ...
        createElement: function(e, n) {
            ...
            i.innerHTML = e; i.firstChild; ) a.appendChild(i.firstChild);
            return a;
        },
    ...
    e.ConfigTemplates.prototype.constructor = e.ConfigTemplates, e.Config = function() {
        ...
        this.behavior = new e.ConfigBehavior(), this.callbacks = new e.ConfigCallbacks(), 
        this.controls = new e.ConfigControls(), this.classNames = new e.ConfigClassNames(), 
        this.data = new e.ConfigData(), this.debug = new e.ConfigDebug(), this.layout = new e.ConfigLayout(), 
        this.load = new e.ConfigLoad(), this.selectors = new e.ConfigSelectors(), this.render = new e.ConfigRender(), 
        this.templates = new e.ConfigTemplates(), this.callActions("afterConstruct"), n.seal(this);
    ...
    n.extend(e.Control.prototype, {
        ...
        this.translateX = new e.TransformData(), this.translateY = new e.TransformData(), 
        this.translateZ = new e.TransformData(), this.rotateX = new e.TransformData(), this.rotateY = new e.TransformData(), 
        this.rotateZ = new e.TransformData(), this.callActions("afterConstruct"), n.seal(this);
    ...
    n.extend(e.Mixer.prototype, {
        ...
        evaluateHideShow: function(t, e, n, a) {
            var i = this;
            i.callActions("beforeEvaluateHideShow", arguments), t === !0 && "show" === n || t === !1 && "hide" === n ? (a.show.push(e), 
            !e.isShown && a.toShow.push(e)) : (a.hide.push(e), e.isShown && a.toHide.push(e)), 
            i.callActions("afterEvaluateHideShow", arguments);
        },
        sortOperation: function(t) {
            var e = this;
            e.callActions("beforeSortOperation", arguments), t.startOrder = e.targets, t.newSort.collection ? t.newOrder = t.newSort.collection : "random" === t.newSort.order ? t.newOrder = n.arrayShuffle(t.startOrder) : "" === t.newSort.attribute ? (t.newOrder = e.origOrder.slice(), 
        ...
        compare: function(t, e, n) {
            ...
            return isNaN(1 * o) || isNaN(1 * r) ? (o = o.toLowerCase(), r = r.toLowerCase()) : (o = 1 * o, 
            r = 1 * r), o < r ? "asc" === i ? -1 : 1 : o > r ? "asc" === i ? 1 : -1 : o === r && n.next ? a.compare(t, e, n.next) : 0;
        },
        ...
        parseEffects: function() {
            ...
            t.effectsOut = new e.StyleData(), t.transformIn = [], t.transformOut = [], t.effectsIn.opacity = t.effectsOut.opacity = 1, 
        ...
        moveTargets: function(t) {
            ...
            for (u = 0; i = t.toHide[u]; u++) r = t.toHidePosData[u], o = new e.IMoveData(), 
            s = "hide", l = a.willTransition(s, r.posIn, r.posOut), o.posIn = r.posIn, o.posOut = r.posOut, 
        ...
        parseMultimixArgs: function(t) {
            ...
            for (i.animate = a.config.animation.enable, i.command = new e.CommandMultimix(), 
            r = 0; r < t.length; r++) o = t[r], null !== o && ("object" == typeof o ? n.extend(i.command, o) : "boolean" == typeof o ? i.animate = o : "function" == typeof o && (i.callback = o));
        ...
        parseDatasetArgs: function(t) {
            var a = this, i = new e.UserInstruction(), o = null, r = -1;
            for (i.animate = a.config.animation.enable, i.command = new e.CommandDataset(), 
        ...
        insertDatasetFrag: function(t, e, n) {
            ...
            for (a.dom.parent.insertBefore(t, e); n.length; ) a.targets.splice(i, 0, n.shift()), 
            i++;
        },
        ...
        toggleOff: function() {
            var t = this, e = t.parseFilterArgs(arguments), n = e.command.selector, a = "";
            return t.isToggling = !0, t.toggleArray.splice(t.toggleArray.indexOf(n), 1), a = t.getToggleSelector(), 
            t.multimix({
                filter: a
            }, e.animate, e.callback);
        },
    ...
    e.BaseStatic.call(e.constructor), e.NAME = "mixitup", e.CORE_VERSION = "3.2.1";
}(window);
...
$(window).on("load", function() {
    ...
    if (window.location.hash && $(window.location.hash).length) {
        var t = $(window.location.hash).offset().top;
        $("html, body").animate({
            scrollTop: t
        });
    }
...
function initNavMenu() {
    var t = $(".hamburger").unbind();
    var e = $(".navbar__nav");
    e.removeClass("navigation-open");
...
function initJsHeight() {
    (function(t) {
        t(".js-height-full").height(t(window).height());
        t(".js-height-parent").each(function() {
            t(this).height(t(this).parent().first().height());
        });
    })(jQuery);
}
