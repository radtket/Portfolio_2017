...
project.videos = `${project.assets}/videos`;
...
function videos() {
	return gulp
		.src(`${project.videos}/**/*`)
		.pipe(gulp.dest(`${project.dist}/videos/`));
}
...
const build = gulp.series(
	clean,
	gulp.parallel(html, css, favicon, images, js, fonts, videos)
);
const watch = gulp.parallel(watchFiles, browserSync);

// export tasks
export { html, images, favicon, videos, fonts, css, js, clean, build, watch };
