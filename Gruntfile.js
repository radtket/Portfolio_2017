...
module.exports = function(grunt) {
	grunt.initConfig({
		...
		browserSync: {
			dev: {
				bsFiles: {
					src: ["dev/css/*.css", "dev/js/*.js", "dev/*.html"]
				},
				options: {
					watchTask: true,
					server: "./dev/"
		...
		uglify: {
			build: {
				...
				src: [
					"dev/src/js/vendor/mixitup.min.js",
			...
			build_secondary: {
				...
				src: [
					"dev/src/js/vendor/covervid.min.js",
					"dev/src/js/compiled/project-page.js"
				],
	...
	grunt.registerTask("default", [
		...
		"babel",
		"uglify:dev",
		"uglify:dev_secondary",
		"htmlmin:dev",
		"responsive_images:clients",
		"responsive_images:portfolio",
		"watch"
	]);
