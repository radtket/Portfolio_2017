var coverVid = function(e, t, o) {
    ...
    function n() {
        var i = e.parentNode.offsetHeight, n = e.parentNode.offsetWidth, a = t, r = o, s = i / r, c = n / a;
        c > s ? (e.style.height = "auto", e.style.width = n + "px") : (e.style.height = i + "px", 
        e.style.width = "auto");
    }
    document.addEventListener("DOMContentLoaded", n), window.addEventListener("resize", i(n, 50)), 
...
$(window).on("load", function() {
    ...
    if (window.location.hash && $(window.location.hash).length) {
        var e = $(window.location.hash).offset().top;
        $("html, body").animate({
            scrollTop: e
        });
    }
